...
class ProblemWriter_json(AbstractProblemWriter):
    ...
    def _collect_model(self, model,
        ...
        data = {}
        data['cfg'] = {}
        data['cfg']['symbolic_solver_labels'] = int(symbolic_solver_labels)
        data['cfg']['skip_trivial_constraints'] = int(skip_trivial_constraints)
        data['cfg']['file_determinism'] = file_determinism
        data['cfg']['include_all_variable_bounds'] = int(include_all_variable_bounds)
        data['obj'] = []
        data['con'] = []
        ...
        for block in all_blocks_list:
            ...
            for active_objective in block.component_data_objects(Objective,
                ...
                objdata['min'] = active_objective.is_minimizing()
