NOTE:  This branch includes changes for creating an object that redirects
imports to pyomo packages.  This capability might be used in pyomocommunity, so I'm keeping this branch for now.
